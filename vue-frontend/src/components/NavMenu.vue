<template>
  <nav class="navbar3" v-if="isHeaderVisible">
    ...
    <div
      class="my-user"
      v-if="logged_in"
      @mouseenter="my_username_visible = true"
      @mouseleave="my_username_visible = false"
    >
      <div class="user-icon">
        <i class="fas fa-user-circle"></i>{{ username }}
      </div>
      <div v-if="my_username_visible" class="my-user-div">
        <div>Salut {{ username }}</div>
        <div class="my-commands" @click="goToCommands()">Comenzile mele</div>
        <div class="my-commands" @click="logout()">Logout</div>
      </div>
    </div>
    <div
      v-if="!logged_in"
      class="my-user"
      @mouseenter="contul_meu_visible = true"
      @mouseleave="contul_meu_visible = false"
    >
      ...
      <div v-if="contul_meu_visible" class="my-user-div">
        ...
        <button
          class="IntraInCont custom-button2"
    ...
    <div>
      <div
        class="nav-menu-button shoppingcart_button"
        style="margin-right: 30px"
        @click="goToShoppingCart()"
      >
        <div v-if="total_count_shopping_cart != 0" class="bulina">
          {{ total_count_shopping_cart }}
        </div>
