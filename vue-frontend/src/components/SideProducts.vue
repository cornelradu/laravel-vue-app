  ...
  <div class="sideMisc">
    <div class="accordion-item accortion-item-1">
      <div class="accordion-header">
        <span class="accordion-header-span-1">Pret</span>
        <i
          v-if="isOpen"
          class="fas fa-chevron-right rotate-90 accordion-header-span"
          @click="toggleAccordion"
        ></i>
        <i
          v-if="!isOpen"
          class="fas fa-chevron-right rotate-270 accordion-header-span"
          @click="toggleAccordion"
        ></i>
      </div>
    ...
    <div class="accordion-item">
      <div class="accordion-header">
        <span class="accordion-header-span-1"> Disponibil prin easybox </span>
        <i
          v-if="isOpen2"
          class="fas fa-chevron-right rotate-90 accordion-header-span"
          @click="toggleAccordion_2"
        ></i>
        <i
          v-if="!isOpen2"
          class="fas fa-chevron-right rotate-270 accordion-header-span"
    ...
    <div class="accordion-item">
      <div class="accordion-header">
        <span class="accordion-header-span-1"> Rating minim </span>
        <i
          v-if="isOpen3"
          class="fas fa-chevron-right rotate-90 accordion-header-span"
          @click="toggleAccordion_3"
        ></i>
        <i
          v-if="!isOpen3"
          class="fas fa-chevron-right rotate-270 accordion-header-span"
      ...
      <div v-if="isOpen3" class="accordion-content accordion-content-price">
        <div>
          <input
            ...
            type="checkbox"
          /><i class="fas fa-star" style="color: rgb(232, 232, 117)"></i
          ><i class="fas fa-star" style="color: rgb(232, 232, 117)"></i
          ><i class="fas fa-star" style="color: rgb(232, 232, 117)"></i
          ><i class="fas fa-star" style="color: rgb(232, 232, 117)"></i
          ><i class="fas fa-star" style="color: rgb(232, 232, 117)"></i>
